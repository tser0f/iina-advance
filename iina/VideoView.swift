...
class VideoView: NSView {
  ...
  ///
  /// Changes in Big Sur broke the legacy full screen feature. The `PlayWindowController` method `legacyAnimateToWindowed`
  ...
  /// full screen mode. A side effect of restoring the window's title is that AppKit stops calling `PlayWindowController.mouseUp`.
