...
class InspectorWindowController: NSWindowController, NSWindowDelegate, NSTableViewDelegate, NSTableViewDataSource {
  ...
  override func showWindow(_ sender: Any?) {
    ...
    observers.append(NotificationCenter.default.addObserver(forName: .iinaPlayWindowChanged, object: nil, queue: .main, using: self.fileLoaded))
  ...
  func updateInfo(dynamic: Bool = false) {
    ...
    DispatchQueue.main.async {
      ...
      self.setLabelColor(self.vPixelFormat, by: player.info.fileLoaded)
    }
  }
